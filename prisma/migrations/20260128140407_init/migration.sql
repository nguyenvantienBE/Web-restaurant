-- CreateEnum
CREATE TYPE "TableStatus" AS ENUM ('EMPTY', 'SEATED', 'ORDERING', 'SERVING', 'NEED_PAYMENT', 'NEED_CLEAN');

-- CreateEnum
CREATE TYPE "TableSessionStatus" AS ENUM ('OPEN', 'CLOSED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW', 'CONFIRMED', 'IN_PROGRESS', 'READY', 'SERVED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "OrderType" AS ENUM ('DINE_IN', 'TAKEAWAY');

-- CreateEnum
CREATE TYPE "ItemStatus" AS ENUM ('NEW', 'COOKING', 'READY', 'SERVED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "Table_tableCode_idx" ON "Table"("tableCode");
...
-- CreateIndex
CREATE INDEX "StaffCall_orderId_idx" ON "StaffCall"("orderId");

-- CreateIndex
CREATE INDEX "StaffCall_isResolved_idx" ON "StaffCall"("isResolved");
...
-- AddForeignKey
ALTER TABLE "StaffCall" ADD CONSTRAINT "StaffCall_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;
